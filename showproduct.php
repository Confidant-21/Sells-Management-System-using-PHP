  ...
  <div class="container">
    ...
    <form action="order.php" method="post">
      <table class="table">
        ...
        <tbody>
          <tr>
            <td><input type="number" name="product_id" id="product_ids[]" placeholder="Product ID"></td>
            <td><input type="number" name="quantitie" id="quantities[]" placeholder="Quantity"></td>
          </tr>
          </tbody>
      </table>
